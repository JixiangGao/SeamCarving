...
class SeamCarving(wx.Frame):
    ...
    def init_bottom(self):
        ...
        self.combobox = wx.ComboBox(self, -1, pos=(470, size.GetHeight()-80), size=(80, -1),
                    choices=choices, style=wx.CB_READONLY, value='Rgb')
    ...
    def initMenu(self):
        ...
        self.m1.Append(self.ID_SAVE, u"保存(&S)\tCtrl+S")
        ...
        # m2 = wx.Menu()
        # ID_EN = wx.NewId()
        # m2.Append(ID_EN, u"识别英文(&E)\tCtrl+E")
        # menu.Append(m2, u"OCR(&T)")

        # m3 = wx.Menu()
        # ID_IM_EN = wx.NewId()
        # m3.Append(ID_IM_EN, u"图像增强(&W)\tCtrl+W")
        # menu.Append(m3, u"图像(&I)")
        ...
        # self.Bind(wx.EVT_MENU, self.OnEn, id=ID_EN)
        # self.Bind(wx.EVT_MENU, self.OnImen, id=ID_IM_EN)
